...
from deductiv_helpers import setup_logger, get_uncompressed_size, SearchConsole
					...
					if data_bytes > 0:
						if not self.append:
							...
							try:
								...
								ui.exit_error(f'Failed to delete collection {file_app}/{file_collection}: {repr(e)}' % (file_app, file_collection, repr(e)))
