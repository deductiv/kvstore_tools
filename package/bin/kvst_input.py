...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-kvstore_tools_account",
    )
    account_conf_file = cfm.get_conf("kvstore_tools_account")
...
class Input(smi.Script):
    ...
    def get_scheme(self):
        scheme = smi.Scheme("kvst_input")
        scheme.description = "kvst_input input"
